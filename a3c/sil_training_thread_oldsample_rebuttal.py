...
class SILTrainingThread(CommonWorker):
    ...
    def sil_train(self, sess, global_t, sil_memory, m,
                  ...
                  rollout_buffer=None, rollout_proportion=0.5, stop_rollout=False,
                  roll_any=False):
